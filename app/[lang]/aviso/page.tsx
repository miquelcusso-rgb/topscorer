...
const EN: LegalBlock[] = [
  ...
  { h: 'About the IIG metric', p: 'The IIG metric is a proprietary calculation by Furiosa Studio derived from the above data; it is our interpretation and not an official rating. We strive for accuracy but cannot guarantee third-party data is correct or current. If you are a rights holder with a concern, contact support@top-scorers.com.' },
]
