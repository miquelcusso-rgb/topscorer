...
export const T = {
  ...
  pricing_pro_f2:       { es: 'Top 25 + todas las temporadas desde 20/21', en: 'Top 25 + all seasons since 20/21' },
  pricing_pro_f3:       { es: 'Stats avanzados: G/90, A/90, disparos, pases clave', en: 'Advanced stats: G/90, A/90, shots, key passes' },
  pricing_pro_f4:       { es: 'Radar completo + comparador de jugadores', en: 'Full radar + player comparator' },
  pricing_pro_f5:       { es: 'Trayectoria de temporada visual', en: 'Visual season trajectory' },
  ...
  pricing_val_upto50:       { es: 'Hasta 50', en: 'Up to 50' },
  ...
  pricing_val_export_pro_100:{ es: '100/mes', en: '100/month' },
